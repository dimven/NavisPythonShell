...
{
    static class RevitPythonShellApplication
    {
        ...
        public static void OnLoaded()
        {
            try
            {
				...
				AppDomain.CurrentDomain.Load(typeof(RpsConfig).Assembly.GetName() );
        ...
        private static string GetSettingsFolder()
        {
        	...
        	return Path.GetDirectoryName(typeof(RevitPythonShellApplication).Assembly.Location);
        }
