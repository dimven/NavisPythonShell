...
namespace RevitPythonShell.RpsRuntime
{
    ...
    public abstract class RpsExternalApplicationBase
    {
...
//        }
        ...
        private void ExecuteStartupScript(XDocument addinXml, Assembly addinAssembly)
        {
        	string message = "";
            ...
            if (startupScript != null)
            {
                ...
                if (result == -1)
                {
                    ...
                    Forms.MessageBox.Show(executor.Message, "RevitPythonShell - StartupScript");
                }
            }
        }
